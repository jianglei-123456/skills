#!/usr/bin/env python3
"""Insert owner info for a device (write step, 3rd of 3).
...
with the user-provided value. Auth header is `Bearer <token>`.
    ...
    python install_iot_owner_insert.py --token "$TOKEN" --imei YS0285093740549
"""
...
INSERT_URL = "https://dss.datian360.com/prod_api/dtbd/installIotOwner/insert"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Insert DT owner info by IMEI.")
